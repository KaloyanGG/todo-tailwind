  ...
  return (
    <div className="flex items-center pr-4">
      ...
      <button
        ...
        type="button"
        className="translate relative z-10 ml-auto cursor-pointer font-semibold after:absolute after:top-[-15%] after:left-[-15%] after:-z-10 after:hidden after:h-[130%] after:w-[130%] after:rounded-full after:bg-text-muted hover:after:block"
      >
        <svg
